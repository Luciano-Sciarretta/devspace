# Generated by Django 4.2 on 2025-09-24 21:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='message',
            index=models.Index(fields=['sender', 'created'], name='users_messa_sender__1e1963_idx'),
        ),
        migrations.AddIndex(
            model_name='message',
            index=models.Index(fields=['recipient', 'is_read', 'created'], name='users_messa_recipie_c8a6d1_idx'),
        ),
    ]
